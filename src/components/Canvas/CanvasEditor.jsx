...
import { generateIconDataUrl } from '@/hooks/useIconRenderer.js';

function CanvasIcon({ element, isSelected, onSelect }) {
...
function CanvasShape({ element, isSelected, onSelect }) {
...
function CanvasText({ element, isSelected, onSelect }) {
...
function CanvasArrow({ element, isSelected, onSelect }) {
  const updateElement = useCanvasStore((s) => s.updateElement);
