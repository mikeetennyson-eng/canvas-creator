    ...
    <div className="min-h-screen bg-background overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature) => {
              ...
              return (
                <div
                  key={feature.title}
                  className="p-8 rounded-xl border border-border bg-card hover:border-primary/50 hover:shadow-lg transition-all"
                >
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-primary/5 to-accent/5 border-t border-border">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            Join thousands of users creating beautiful diagrams with Canvas Creator
          </p>
          <Button
            onClick={() => navigate(isAuthenticated ? '/editor' : '/signup')}
            size="lg"
            className="gap-2 bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70"
          >
      ...
      <footer className="border-t border-border bg-card/50 py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center text-muted-foreground">
          <p>&copy; 2024 Canvas Creator. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
